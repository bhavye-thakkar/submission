...
class _NoteCardState extends State<NoteCard> {
  ...
  Widget _buildWideNoteItem() {
    Color backgroundColor = widget.index.isEven ? Constants().primaryColor: Color(0xC7E0DF);
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: ListTile(
            ...
            trailing: InkWell(
                child: Icon(Icons.delete, color: widget.index.isEven ? Color(0xFFF9AD3D) : Constants().secondaryColor,),
                onTap: widget.onDelete,
              ),
          ),
        ),
